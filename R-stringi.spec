...
Version  : 1.4.4
Release  : 72
URL      : https://cran.r-project.org/src/contrib/stringi_1.4.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/stringi_1.4.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578696558
