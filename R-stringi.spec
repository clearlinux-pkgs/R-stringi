...
Version  : 1.1.5
Release  : 28
URL      : http://cran.r-project.org/src/contrib/stringi_1.1.5.tar.gz
Source0  : http://cran.r-project.org/src/contrib/stringi_1.1.5.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1492799872
