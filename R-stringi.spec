...
Version  : 1.8.7
Release  : 119
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/stringi_1.8.7.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/stringi_1.8.7.tar.gz
...
%package dev
Summary: dev components for the R-stringi package.
Group: Development
Requires: R-stringi-lib = %{version}-%{release}
Provides: R-stringi-devel = %{version}-%{release}
Requires: R-stringi = %{version}-%{release}

%description dev
dev components for the R-stringi package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743173884
